...
**Usage**
1. Open the app and upload a .pdf, .docx, or .txt file
2. Adjust your reading speed (WPM) using the slider
3. Press play to begin speed reading
4. Optionally enable Speed Scaling or Background Music
5. Use fullscreen mode for a distraction-free experience
